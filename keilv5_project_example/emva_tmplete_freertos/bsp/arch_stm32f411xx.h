/**
  ...
  ******************************************************************************
  */
#ifndef __DL_SYSTEM_H_
#define __DL_SYSTEM_H_
...
#define PC(x) 		 BIT_ADDR(GPIOC_ODR_Addr, x)
...
void usart1_callback(uint8_t dt);
void usart2_callback(uint8_t dt);
void usart3_callback(uint8_t dt);
...
extern inline void time2_callback(void);
void Time2Init(void);
