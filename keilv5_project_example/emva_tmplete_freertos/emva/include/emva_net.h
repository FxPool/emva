...
extern "C"
{
        ...
        struct _Conn
        {
                ...
                dv_error *(*Event)(EmvaConn *c, void (*p)(void));
                ...
                dv_error *(*Read)(EmvaConn *c, byte *b, uint32 nread, int32 *nrecv);
                ...
                dv_error *(*Write)(EmvaConn *c, byte *b, uint32 n);
                ...
                dv_error *(*SetWriteDeadline)(EmvaConn *c, uint32 t);
        };
        struct _Dialer
        {
                // Connect address to Conn on network and return Conn.The types of networks available are:
                //" TCP ", "tcp4", "udp", "udp4", "IP", "ip4""
                EmvaConn *(*Dial)(dv_error *err, char *Network, char *address);
                EmvaConn *(*DialTimeout)(dv_error *err, char *Network, char *address, uint32 Millisecond);
                bool (*LoadDriver)(const char *DriverName);
        };
        extern Dialer EmvaNet;
        extern bool EmvaNetInitialize(const char *name);
#ifdef __cplusplus
}
#endif
